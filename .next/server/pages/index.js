...
async function getStaticProps() {
  ...
  const client = await external_mongodb_["MongoClient"].connect("mongodb+srv://mongoose-mongodb:1234@cluster0.qwybnjp.mongodb.net/meetups?retryWrites=true&w=majority");
  const db = client.db();
